...
AFIRMACIONES <- list(
  ...
  c("Curva de calibracion por tramos", "outputs/fase35/curva_calibracion.csv"),
  c("Recorrido de la probabilidad predicha", "outputs/fase35/rango_probabilidad.csv"),
  c("Cota sobre la regla del maximo", "outputs/fase35/separacion_argmax.csv"),
  c("Pendiente de calibracion", "outputs/fase35/pendiente_calibracion.csv"),
  ...
  c("Cascada de casos completos", "outputs/fase32/cascada_casos_completos.csv"),
  c("Completos por conjunto de la particion", "outputs/fase32/completos_por_grupo.csv"),
  c("Conjunto ajustado por grupo y clase", "outputs/fase32/conjunto_por_grupo_y_clase.csv"),
  c("Completitud por conjunto de la particion", "outputs/fase36/completitud_por_conjunto.csv"),
  ...
  c("Orden de la matriz de analisis", "outputs/fase39/orden_de_la_matriz.csv"),
  ...
  c("Situacion de cada deposito", "outputs/fase44/depositos.csv"),
  c("Recuento de depositos por situacion", "outputs/fase44/recuento.csv"),
  c("Tipos de muestra en la ventana", "outputs/tipos_muestra_ventana6h.csv"),
  c("Basales por conjunto de la particion",
    "outputs/fase45/basales_por_conjunto.csv"),
  c("Categorias de desenlace por conjunto",
    "outputs/fase45/categorias_por_conjunto.csv"),
  c("Determinaciones por conjunto",
    "outputs/fase45/determinaciones_por_conjunto.csv"),
  c("Positividad por tipo de muestra",
    "outputs/fase43/positividad_retenidos.csv"),
  c("Resumen de la positividad", "outputs/fase43/resumen_positividad.csv"),
  c("Distancia de la unidad reservada",
    "outputs/fase42/distancia_de_la_reservada.csv"),
  c("Extremos por categoria de la reservada",
  ...
  c("Potencia que el ajuste no uso", "outputs/fase32/potencia_no_usada.csv"),
