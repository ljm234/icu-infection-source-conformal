...
"reads every tracked CSV in full, not only its header, since an identifier",
"can arrive as a value and not only as a column name; it also flags any",
"tracked table with as many rows as the cohort has stays, which is a",
"patient-level table by shape whatever its columns are called. It lists the",
"tracked binary objects with their sizes and checks that none of the",
"protected paths appears in the commit history.",
"",
"## Cohort",
""))
